...
import { transparentize, lighten, modularScale, darken, parseToRgb, mix, normalize } from 'polished';
...
function patchStyledComponent(StyledComponent) {
  ...
  StyledComponent.withComponent = function (component) {
    ...
    return patchStyledComponent(Object.assign(baseWithComponent.apply(void 0, [NewTarget].concat(args)), StyledComponent));
  };

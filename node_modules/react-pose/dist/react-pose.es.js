...
import { createElement, createContext, Component, PureComponent, cloneElement, Children } from 'react';
...
var PoseElement = (function (_super) {
    ...
    PoseElement.prototype.render = function () {
        ...
        return (createElement(PoseParentProvider, { value: this.childrenHandlers }, createElement(elementType, pickAssign(this.shouldForwardProp, [
            this.getSetProps(),
            this.getRefs()
        ]))));
    };
...
var createComponentFactory = function (key) {
    var componentFactory = function (poseConfig) {
        ...
        return function (_a) {
            ...
            return !withParent || props.parentValues ? (createElement(PoseElement, __assign({ poseConfig: poseConfig, elementType: key }, props))) : (createElement(PoseParentConsumer, null, function (parentCtx) { return (createElement(PoseElement, __assign({ poseConfig: poseConfig, elementType: key }, props, parentCtx))); }));
        };
    };
